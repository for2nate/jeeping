        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => CurrentCategoryWidget(
            ...
            FFRoute(
              ...
              path: 'currentRoute',
              asyncParams: {
                'route': getDoc(['Routes'], RoutesRecord.fromSnapshot),
              },
              builder: (context, params) => CurrentRouteWidget(
                route: params.getParam('route', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'EditRoute',
            ...
            FFRoute(
              ...
              path: 'currentGuide',
              asyncParams: {
                'guide': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => CurrentGuideWidget(
                guide: params.getParam('guide', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Onboarding',
            ...
            FFRoute(
              name: 'IssignGuide',
              path: 'issignGuide',
              builder: (context, params) => IssignGuideWidget(),
            ),
            FFRoute(
              name: 'EditProfile',
              path: 'editProfile',
            ...
            FFRoute(
              name: 'AddHike',
              path: 'addHike',
              builder: (context, params) => AddHikeWidget(),
            ),
            FFRoute(
              name: 'EditHike',
              path: 'editHike',
              asyncParams: {
                'hike': getDoc(['Hikes'], HikesRecord.fromSnapshot),
              },
              builder: (context, params) => EditHikeWidget(
                hike: params.getParam('hike', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Participants',
            ...
            FFRoute(
              ...
              path: 'currentOrder',
              asyncParams: {
                'buying': getDoc(['orders'], OrdersRecord.fromSnapshot),
              },
              builder: (context, params) => CurrentOrderWidget(
                buying: params.getParam('buying', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Payment',
            ...
            FFRoute(
              name: 'ManageRoutes',
              path: 'manageRoutes',
              builder: (context, params) => ManageRoutesWidget(),
            ),
            FFRoute(
              name: 'ManageServices',
              path: 'manageServices',
              builder: (context, params) => ManageServicesWidget(),
            ),
            FFRoute(
              name: 'AddCategory',
              path: 'addCategory',
            ...
            FFRoute(
              ...
              builder: (context, params) => ManageCategoriesWidget(),
            ),
            FFRoute(
              name: 'ForgotPassword',
              path: 'forgotPassword',
