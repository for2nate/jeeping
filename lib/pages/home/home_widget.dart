          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<RoutesRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<RoutesRecord> rowRoutesRecordList = snapshot.data!;
                    return SingleChildScrollView(
                      scrollDirection: Axis.horizontal,
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: List.generate(rowRoutesRecordList.length,
                            (rowIndex) {
                          final rowRoutesRecord = rowRoutesRecordList[rowIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 12.0, 0.0, 24.0),
                            child: InkWell(
