...
import 'manage_routes_model.dart';
export 'manage_routes_model.dart';

class ManageRoutesWidget extends StatefulWidget {
  const ManageRoutesWidget({Key? key}) : super(key: key);

  @override
  _ManageRoutesWidgetState createState() => _ManageRoutesWidgetState();
}

class _ManageRoutesWidgetState extends State<ManageRoutesWidget>
    with TickerProviderStateMixin {
  late ManageRoutesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageRoutesModel());
