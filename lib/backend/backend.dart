...
import 'schema/hikes_record.dart';
...
export 'schema/hikes_record.dart';
...
/// Functions to query HikesRecords (as a Stream and as a Future).
Future<int> queryHikesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HikesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HikesRecord>> queryHikesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HikesRecord.collection,
      HikesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HikesRecord>> queryHikesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
